...
def warn_deprecated(
    ...
    *,
    ...
    # Create a log record for the deprecation warning.
    # This allows developers to capture and analyze deprecation warnings
    # in a structured way, for example, by writing them to a file.
